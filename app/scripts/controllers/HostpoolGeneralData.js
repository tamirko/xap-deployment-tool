...
/**
 * @ngdoc function
 * @name demoApp.controller:HostpoolGeneralDataCtrl
 * @description
 * # HostpoolGeneralDataCtrl
 * Controller of the demoApp
 */
angular.module('demoApp')
  .controller('HostpoolGeneralDataCtrl', function ($scope) {

        $scope.name = 'Hostpool Cloud Provider';
