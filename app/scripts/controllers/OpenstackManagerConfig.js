...
/**
 * @ngdoc function
 * @name demoApp.controller:OpenstackManagerConfigCtrl
 * @description
 * # OpenstackManagerConfigCtrl
 * Controller of the demoApp
 */
angular.module('demoApp')
    .controller('OpenstackManagerConfigCtrl', function ($scope) {
